...
const registerUser = asyncHandler(async (req, res) => {
  ...
  const uploadedProfilePic = await uploadOnCloudinary(req.file.buffer, "profile_pics");

  if (!uploadedProfilePic?.secure_url) {
...
const updateUserProfilePic = asyncHandler(async (req, res) => {
  ...
  const profilePic = await uploadOnCloudinary(req.file.buffer, "profile_pics");
